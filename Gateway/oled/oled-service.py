...
Based on INTEL-IRRIS oled service.
https://intel-irris.eu/ and https://github.com/CongducPham/PRIMA-Intel-IrriS

Author: C. Pham. Last update Feb 28th, 2025 (for WaziGate v2).

Called by /etc/systemd/system/default-oled-service.service

some useful commands:

- sudo systemctl stop default-oled-service.service
- systemctl status default-oled-service.service
- journalctl -u default-oled-service.service
...
while True:
	...
	draw.text((x, ttop), "GenericSensorGateway", font=font, fill=255)
	ttop=ttop+font_size	
