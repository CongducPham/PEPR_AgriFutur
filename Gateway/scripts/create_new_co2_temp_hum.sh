...
echo "--> calling create_full_co2_temp_hum_device_with_dev_addr.sh ${DEFAULT_CO2_NAME} $2 $OPT_DEV_ID $OPT_NO_INIT"
/home/pi/scripts/create_full_co2_temp_hum_device_with_dev_addr.sh ${DEFAULT_CO2_NAME} $2 $OPT_DEV_ID $OPT_NO_INIT
fi
