...
# Ex: create_new_co2_temp_hum.sh 3 E1

echo "--> calling create_full_co2_temp_hum_device_with_dev_addr.sh $1 $2"
./create_full_co2_temp_hum_device_with_dev_addr.sh $1 $2
