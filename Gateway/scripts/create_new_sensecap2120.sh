...
if [[ -n $DEV_EUI ]]; then
  ...
  /home/pi/scripts/create_sensecap2120_device.sh ${DEFAULT_SENSECAP2120_NAME} $OPT_DEV_EUI $OPT_DEV_ID $OPT_NO_INIT
else
  ...
  /home/pi/scripts/create_sensecap2120_device.sh ${DEFAULT_SENSECAP2120_NAME} $OPT_DEV_FULL_ADDR $OPT_APPSKEY $OPT_NWKSKEY $OPT_DEV_ID $OPT_NO_INIT  
fi
