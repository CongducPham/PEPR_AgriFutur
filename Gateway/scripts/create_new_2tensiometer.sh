...
if [[ -n $DEV_FULL_ADDR ]]; then
  ...
  echo "--> create_full_2tensiometer_device_with_dev_addr.sh ${DEFAULT_2TENSIOMETER_NAME} $OPT_DEV_ID $OPT_NO_INIT $OPT_DEV_FULL_ADDR $OPT_APPSKEY $OPT_NWKSKEY"
  ...
  echo "--> calling create_full_2tensiometer_device_with_dev_addr.sh ${DEFAULT_2TENSIOMETER_NAME} $2 $OPT_DEV_ID $OPT_NO_INIT"
  /home/pi/scripts/create_full_2tensiometer_device_with_dev_addr.sh ${DEFAULT_2TENSIOMETER_NAME} $2 $OPT_DEV_ID $OPT_NO_INIT
fi
