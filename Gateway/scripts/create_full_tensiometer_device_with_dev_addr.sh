...
# Ex: create_full_tensiometer_device_with_dev_addr.sh TENSIOMETER_1 --no-init --dev-full-addr 260B4515 --appskey BEB72ECC54873DAB0AEE5478ADAB41B7 --nwkskey 262060AA21142DAF8D05902C54F34C58
#
...
# Ex: create_full_tensiometer_device_with_dev_addr.sh TENSIOMETER_1 --no-init --dev-eui AC1F09FFFE12DA3F
